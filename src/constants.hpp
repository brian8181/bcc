...
enum token_id : unsigned long
    {
		...
		ID_MODIFIER_TRUNCATE    = 0x100000009ul,                          x
		// ID_MODIFIER_SPACIFY     = 0x4000000 000ul,
		// ID_MODIFIER_STRINGF_FORMAT = 0x8000000 000ul,
		// ID_MODIFIER_DATE_FORMAT    = 0x10000000 000ul,
		// ID_MODIFIER_ESCAPE         = 0x20000000 000ul,
		ID_UNESCAPED_TEXT = 0x100000 012ul,
